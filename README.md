...
Olist est une “marketplace integrator platform”, c’est-à-dire une plateforme qui aide des fournisseurs à vendre leurs produits sur des grandes marketplaces existantes comme Amazon.  
**Le but du projet est d’analyser et de proposer des axes de croissances à l’entreprise Olist en analysant leurs ventes.**

Le projet est composé d'un ELT principalement gérée avec DBT (dossier "dbt_project" dans le repo).  
Dans un second temps, l'analyse et la visualisation des tableaux se font sur Tableau, pandas+seaborn, Excel (dossier "dev" dans le repo).
...
**Conclusion (TLDR): Les Etats de Bahia (BH) et de Rio Grande do Sul (RS) montrent des signes très positifs de potentiel business.
...
Les données sont d’abord matérialisées dans des table de staging.  
...
## Analyse des résultats concernants les fournisseurs avec Tableau

### Où soutenir et développer l'implémentation de nouveaux fournissuers?
...
Juste après, ce sont les régions de Minas Gerais (MG, 21M d'habitants) et Rio de Janeiro (RJ, 17M d'habitants) qui sont le plus peuplées.  
...
Cependant les deux régions en rouge pâle sont relativement sous développées en terme de chiffre d'affaires fournisseurs générés comparés à leur population (15M à Bahia BA au nord, et 11M à Rio Grande do Sul RS au Sud) 
  ...
  ### Quelles sont les tendances côtés fournisseur?
...
|:--:|
| *Image 7 - Les Etats les plus consomatteurs ont un panier moyen situé entre 100R$ et 200$ (Equivaut à 1 semaine de courses pour une personne)* |
...
|:--:|
| *Image 8 - Les 17 fournisseurs générant le plus de CA n'ont pas des frais de transport comparables* |
...
## Analyse des résultats concernants les clients finaux avec Tableau

### Où sont les clients finaux?

La répartition du CA client par région (d'où vient l'argent) est légèrement différent du CA fournisseur (où va l'argent)
...
|:--:|
| *Image 11 - Catégories de produits d'appels par ordre de nombre de commande** |
...
* **afin de les inciter à se diriger vers ces produits** 
